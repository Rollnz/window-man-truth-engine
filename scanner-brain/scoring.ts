...
// ═══════════════════════════════════════════════════════════════════════════
// SAFE PREVIEW (Teaser UI — no sensitive details leaked)
// ═══════════════════════════════════════════════════════════════════════════
...
export function generateSafePreview(scored: ScoredResult): SafePreview {
  ...
  return {
    ...
    warningCount: scored.warnings.length,
    missingItemCount: scored.missingItems.length,
    riskLevel,
    hasCriticalCap: scored.hardCap.applied && scored.hardCap.ceiling <= 30,
  };
}
