...
const WindowRiskAndCode = () => {
  ...
  const articleSchema = {
    ...
    "@type": "Article",
    "@id": "https://itswindowman.com/window-risk-and-code",
    "headline": pillar.h1,
    ...
    "mainEntityOfPage": "https://itswindowman.com/window-risk-and-code",
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Window Risk & Code", "item": "https://itswindowman.com/window-risk-and-code" }
    ]
  };
