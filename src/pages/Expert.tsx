...
export default function Expert() {
  ...
  return <div className="flex flex-col min-h-screen bg-background">
      <SEO title="Window Questions Expert" description="Ask any window replacement question and get instant, unbiased AI-powered answers. No sales pitch—just expert facts about pricing, materials, and more." canonicalUrl="https://itswindowman.com/expert" jsonLd={[...getToolPageSchemas('expert-system'), getBreadcrumbSchema('expert-system')]} />
      <Navbar />
      ...
      <section ref={chatSectionRef} className="min-h-[80vh] flex flex-col">
        <ErrorBoundary title="Expert Chat Error" description="We encountered an issue with the AI expert. Please refresh to try again." onReset={() => window.location.reload()}>
          <div className="flex-1 flex flex-col container mx-auto max-w-3xl px-4 mt-[70px]">
            ...
            {/* Error State */}
            {chatError && !isLoading && <div className="px-4 pt-4">
                <AIErrorFallback errorType={getAIErrorType(chatError)} message={chatError} onRetry={() => setChatError(null)} compact />
              </div>}
