...
import { Users, FileText, BarChart3, Flame, TrendingUp, Plus, RefreshCw, Search } from 'lucide-react';
          ...
          {isLoading ? (
            ...
            <>
              ...
              <StatsCard
                ...
                valueClassName={stats.conversionRate >= 10 ? 'text-green-500' : undefined}
              />
            </>
          )}
        </div>
