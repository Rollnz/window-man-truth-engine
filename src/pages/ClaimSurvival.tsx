...
import {
  EvidenceTagFilter,
  EvidenceTag,
  getDefaultTagForDocument,
} from "@/components/claim-survival/EvidenceTagFilter";
...
export default function ClaimSurvival() {
  ...
  const isUnlocked = sessionData.unlockedResources?.includes("claim-survival") || !!sessionData.email;
  ...
  const completedCount = claimDocuments.filter((doc) => vaultProgress[doc.id] || vaultFiles[doc.id]).length;
      ...
      <div className="pt-2">
        ...
        <section className="py-8 border-b border-border">
          <div className="container px-4">
            <ReadinessScore completed={completedCount} total={claimDocuments.length} />
          </div>
        </section>
        ...
        <section id="document-checklist" className="py-12">
          <div className="container px-4">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
              <div>
                <h2 className="text-2xl font-bold mb-2 font-mono uppercase tracking-wide">YOUR 7 CRITICAL DOCUMENTS</h2>
            ...
            {filteredDocuments.length === 0 && selectedTags.length > 0 && (
              <div className="text-center py-12 border border-dashed border-border rounded-lg">
                <p className="text-muted-foreground font-mono text-sm">No documents match the selected filters.</p>
                <Button
                  variant="ghost"
                  size="sm"
        ...
        <section className="py-12 bg-muted/30">
          <div className="container px-4">
            ...
            <PhotoWalkthrough onUploadClick={handleUploadClick} isUnlocked={isUnlocked} />
          </div>
        </section>
        ...
        <section className="py-16">
          <ClaimFinalCTA onCreateVaultClick={handleCreateVaultClick} isUnlocked={isUnlocked} />
        </section>
