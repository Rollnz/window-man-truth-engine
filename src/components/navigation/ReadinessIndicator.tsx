  ...
  return <Tooltip>
      ...
      hasIncreased && 'ring-2 ring-primary/30 animate-pulse')}>
          ...
          <div className="relative">
            ...
            <Zap className={cn('absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3', status.color)} />
          </div>
          ...
          <span className={cn('text-xs font-medium hidden lg:inline', status.color)}>
            {status.label}
          </span>
        </div>
      </TooltipTrigger>
      
      <TooltipContent side="bottom" align="end" className="w-64 p-0 bg-popover border-border">
        <div className="p-3 space-y-3">
          ...
          <p className="text-xs text-muted-foreground">
            {score < 100 ? 'Complete tools below to increase your score and unlock better negotiation power.' : '🎉 High Intent! You\'re ready to take action.'}
          </p>
