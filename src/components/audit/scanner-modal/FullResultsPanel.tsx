    ...
    <div className="space-y-6 px-4 py-6 overflow-y-auto max-h-[70vh]">
      ...
      <div className="rounded-lg bg-emerald-500/10 border border-emerald-500/30 p-4 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-slate-400">Your analysis has been saved to your WindowMan Vault.</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <FullScoreRow
          ...
          description={result.missingItems.length ? `Missing: ${result.missingItems.join(', ')}` : "Scope appears comprehensive."}
