  ...
  return (
    ...
    >
      ...
      <div className="absolute top-8 left-1/2 -translate-x-1/2 z-20">
        <Badge 
          className={cn(
            "px-4 py-2 bg-red-500/20 border-red-500/40 text-red-400 text-sm font-medium backdrop-blur-md transition-all duration-1000",
        ...
        >
          ...
          ALERT: Florida homeowners overpay by $8,000–$15,000 on average
        </Badge>
      </div>
            ...
            <div className="relative overflow-hidden rounded-lg">
              <div className="relative bg-gradient-to-br from-cyan-950/90 via-slate-900/95 to-slate-950 min-h-[500px] md:min-h-[550px] p-8 md:p-12">
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                  <div 
                    className="absolute w-full h-px bg-gradient-to-r from-transparent via-cyan-400/60 to-transparent animate-scan-down"
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full text-center space-y-6">
                  ...
                  <p className={cn(
                    "text-base text-slate-400/80 max-w-xl transition-all duration-700 delay-500",
