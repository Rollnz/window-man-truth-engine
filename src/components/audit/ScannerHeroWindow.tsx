...
export function ScannerHeroWindow({
  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-950 py-12 px-4" onMouseMove={handleMouseMove}>
      ...
      <div className="absolute top-8 left-1/2 -translate-x-1/2 z-20">
        <Badge className={cn("px-4 py-2 bg-red-500/20 border-red-500/40 text-red-400 text-sm font-medium backdrop-blur-md transition-all duration-1000", isVisible ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-4")}>
