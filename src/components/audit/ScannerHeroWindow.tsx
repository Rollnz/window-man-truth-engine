...
export function ScannerHeroWindow({ onScanClick, onViewSampleClick }: ScannerHeroWindowProps) {
  ...
  return (
    <section
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-950 py-12 px-4"
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-64 opacity-10">
          <svg viewBox="0 0 1200 200" className="w-full h-full" preserveAspectRatio="xMidYMax slice">
            <path
              d="M0,200 L0,180 Q50,160 100,180 Q150,120 180,140 L180,200 Z"
              fill="currentColor"
              className="text-emerald-900" />

            <path
              d="M150,200 L150,150 Q200,100 220,130 Q250,80 280,120 L280,200 Z"
              fill="currentColor"
              className="text-emerald-950" />

            <path
              d="M900,200 L900,160 Q950,120 980,150 Q1020,90 1050,130 L1050,200 Z"
              fill="currentColor"
              className="text-emerald-900" />

            <path
              d="M1050,200 L1050,140 Q1100,100 1130,130 Q1160,80 1200,120 L1200,200 Z"
              fill="currentColor"
              className="text-emerald-950" />
      ...
      <div className="absolute top-8 left-1/2 -translate-x-1/2 z-20">
        <Badge
          className={cn(
            "px-3 py-1.5 md:px-4 md:py-2 rounded-md whitespace-nowrap bg-red-500/20 border-red-500/40 text-red-400 text-xs md:text-sm font-medium backdrop-blur-md transition-all duration-1000",
      ...
      <div
        className={cn(
          "relative z-10 w-full max-w-4xl mx-auto transition-all duration-1000",
        ...
        <div className="relative">
          ...
          <div className="relative bg-gradient-to-b from-slate-500 via-slate-600 to-slate-700 p-3 md:p-4 rounded-xl shadow-2xl">
            ...
            <div className="relative overflow-hidden rounded-lg">
              <div className="relative bg-gradient-to-br from-slate-900/90 via-slate-900/95 to-slate-950 min-h-[500px] md:min-h-[550px] p-8 md:p-12">
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                  <div
                    className="absolute w-full h-px bg-gradient-to-r from-transparent via-primary/60 to-transparent animate-scan-down"
                    style={{
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full text-center space-y-6">
                  ...
                  <p
                    className={cn(
                      "text-base max-w-xl transition-all duration-700 delay-500 text-destructive-foreground",
            ...
            <div className="relative -mx-3 md:-mx-4 mt-0">
              ...
              <div className="bg-gradient-to-b from-slate-700 via-slate-750 to-slate-800 px-6 md:px-10 py-8 rounded-b-xl">
                ...
                <div
                  className={cn(
                    "flex flex-col items-center space-y-4 transition-all duration-700 delay-600",
                    isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                  )}>
                  ...
                  <div className="flex flex-col items-center space-y-2">
                      ...
                      className="bg-primary text-white hover:bg-primary/90 hover:text-white px-6 py-2">
          ...
          <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-2 px-4 py-2 bg-slate-800/80 backdrop-blur-sm rounded-full border border-slate-700/50 shadow-lg">
            ...
            <span className="text-xs text-primary-foreground">Powered by Gemini 3 Flash       </span>
          </div>
        </div>
      </div>
      ...
      <div
        className={cn(
          "absolute bottom-8 left-0 right-0 transition-all duration-700 delay-700",
          isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
        )}>
