  ...
  return <section className="py-20 md:py-32 relative bg-secondary/30">
      <div className="container px-4">
        ...
        <div className="text-center text-sm text-muted-foreground mb-12">
          <span className="inline-flex flex-col items-center gap-1 px-4 py-2 rounded-full border border-border bg-background/50">
            <span>✓ You're in control</span>
            <span>Explore any tool in any order</span>
          </span>
        </div>
