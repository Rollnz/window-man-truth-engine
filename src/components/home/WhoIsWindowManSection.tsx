      ...
      <div className="container px-4">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-8 rounded-2xl bg-card border border-border">
              <h3 className="text-xl font-semibold text-foreground mb-4">What You're Actually Looking At</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
                When you receive a window estimate, you aren't just looking at a price.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-4">
                You're looking at a <span className="text-foreground font-medium">legal and technical document</span>{" "}
                designed to protect the company that wrote it — not you.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Most homeowners assume quotes are straightforward: materials, labor, total cost. In reality, the real
                risk lives in what's missing, what's implied, and what's buried in fine print.
              </p>
            </div>
            <div className="p-8 rounded-2xl bg-gradient-to-br from-[hsl(var(--secondary)/0.1)] to-transparent border border-[hsl(var(--secondary)/0.2)]">
              <h3 className="text-xl font-semibold text-[hsl(var(--secondary))] mb-4">The Conflict of Interest</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-[hsl(var(--secondary))] mt-2 flex-shrink-0" />
                  <p className="text-muted-foreground">
                    Contractors are paid to <span className="text-foreground">sell installations</span>.
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-[hsl(var(--secondary))] mt-2 flex-shrink-0" />
                  <p className="text-muted-foreground">
                    Insurers are paid to <span className="text-foreground">deny claims</span>.
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-[hsl(var(--secondary))] mt-2 flex-shrink-0" />
                  <p className="text-foreground font-medium">
                    No one in the process is paid to protect you from blind spots.
                  </p>
                </div>
              </div>
              <p className="text-xl font-semibold text-foreground mt-6">That's the gap Window Man fills.</p>
            </div>
          </div>
        </div>
        <div className="max-w-4xl mx-auto mb-16">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
              ...
              experienced inspectors, insurance adjusters, and seasoned industry professionals.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="p-8 md:p-12 rounded-2xl bg-card border border-border">
            <div className="text-center mb-10">
              <p className="text-sm font-medium text-[hsl(var(--secondary))] mb-2">RADICAL TRANSPARENCY</p>
              <h3 className="text-2xl md:text-3xl font-bold text-foreground">How Window Man Makes Money</h3>
              <p className="text-muted-foreground mt-2">(Why this works in your favor)</p>
            </div>
            <p className="text-center text-lg text-muted-foreground mb-10">
              Let's remove all ambiguity. The audit is{" "}
              <span className="text-foreground font-semibold">100% free. Period.</span>
              <br />
              No credit card. No obligation. No upsell.
            </p>
            <div className="grid md:grid-cols-2 gap-8 mb-10">
              <div className="p-6 rounded-xl bg-primary/5 border border-primary/20">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-foreground">The Free Path</h4>
                </div>
                <p className="text-muted-foreground leading-relaxed">
                  Get your audit. See the risks. Use the data to negotiate with your current contractor.
                  <span className="block mt-2 text-foreground font-medium">
                    It costs you $0, and we stay in your corner.
                  </span>
                </p>
              </div>
              <div className="p-6 rounded-xl bg-[hsl(var(--secondary)/0.05)] border border-[hsl(var(--secondary)/0.2)]">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-lg bg-[hsl(var(--secondary)/0.2)] flex items-center justify-center">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  If you choose, we'll take your red-flagged project specs — never your personal information — and run
                  them through our vetted partner network. We force top-tier contractors to compete on the same scope,
                  same materials, with better protections.
                </p>
              </div>
            </div>
            <div className="p-6 rounded-xl bg-gradient-to-r from-primary/5 via-transparent to-[hsl(var(--secondary)/0.05)] border border-border mb-10">
              <h4 className="text-lg font-semibold text-foreground mb-4 text-center">How We Win</h4>
              ...
              <div className="flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-center md:gap-6 mt-6">
                ...
                <div className="flex items-center gap-2">
                  <DollarSign className="w-5 h-5 text-[hsl(var(--secondary))]" />
                  <span className="text-sm text-foreground">We get paid by the pro</span>
                </div>
                <div className="flex items-center gap-2">
                  <Handshake className="w-5 h-5 text-amber-500" />
                  <span className="text-sm text-foreground">The industry gets more honest</span>
                </div>
              </div>
            </div>
