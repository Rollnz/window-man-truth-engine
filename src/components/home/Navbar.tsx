  ...
  return <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          {!loading && (isAuthenticated ? <Button variant="outline" size="sm" asChild className="relative">
                <Link to={ROUTES.VAULT}>
                  ...
                  My Vault
                  {hasNotifications && <TooltipProvider>
                      <Tooltip>
              ...
              </Button> : <Button variant="default" size="sm" asChild className="bg-primary text-primary-foreground hover:bg-primary/90">
                <Link to={ROUTES.AUTH}>
      ...
      {mobileMenuOpen && <div className="md:hidden border-t border-border bg-background px-4 py-4 space-y-1">
          ...
          {!loading && (isAuthenticated ? <Button variant="outline" size="sm" asChild className="w-full relative">
              ...
              </Button> : <Button variant="default" size="sm" asChild className="w-full bg-primary text-primary-foreground hover:bg-primary/90">
