...
export function HeroSection() {
  return <section className="relative min-h-[95vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 px-4 py-20 md:py-32">
        ...
        }}><Link to="/sample-report" className="inline-flex items-center text-[hsl(var(--primary-light))] hover:text-[hsl(var(--primary-light))]/80 transition-colors group"><span className="border-b border-[hsl(var(--primary-light))]/50 group-hover:border-[hsl(var(--primary-light))] text-xl">View a Real Sample AI Report</span><span className="ml-2 transition-transform group-hover:translate-x-1">→</span></Link><p className="text-xs text-muted-foreground mt-1">See exactly what the analysis looks like first</p></div>
        </div>
      </div>
