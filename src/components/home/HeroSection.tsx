    ...
    <section className="relative min-h-[95vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 px-4 py-20 md:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 animate-fade-in-up"><span className="text-foreground">You Don't Lose Money on Windows</span><br /><span className="text-foreground">Because Prices Are High.</span><span className="block mt-4 text-primary" style={{ textShadow: '0 0 40px hsl(var(--primary) / 0.4)' }}>You Lose Money Because You Don't Know What You Don't Know.</span></h1>
