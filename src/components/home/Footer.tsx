        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <Link to={ROUTES.EXPERT} className="inline-flex items-center gap-2 text-sm text-primary hover:text-primary/80 transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to={ROUTES.REALITY_CHECK} className="text-sm text-foreground hover:text-primary transition-colors">
                    Reality Check Tool
                  </Link>
                </li>
                <li>
                  <Link to={ROUTES.COST_CALCULATOR} className="text-sm text-foreground hover:text-primary transition-colors">
                    Cost of Inaction Calculator
                  </Link>
                </li>
                <li>
                  <Link to={ROUTES.COMPARISON} className="text-sm text-foreground hover:text-primary transition-colors">
                    Comparison Tool
                  </Link>
                </li>
                <li>
                  <Link to={ROUTES.EVIDENCE} className="text-sm text-foreground hover:text-primary transition-colors">
                    Evidence Locker
                  </Link>
                </li>
              </ul>
