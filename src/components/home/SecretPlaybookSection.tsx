...
function RiskCard({
  ...
  return <div className="group relative p-6 rounded-xl transition-all duration-300 hover:translate-y-[-4px] hover:shadow-lg border-2 border-primary bg-[#eef6fc]">
      ...
      <h4 className="font-semibold mb-1 text-base text-black">{title}</h4><p className="text-sm font-medium text-[hsl(var(--secondary))] mb-3">{subtitle}</p><p className="text-sm text-muted-foreground leading-relaxed">{description}</p>
    </div>;
}
