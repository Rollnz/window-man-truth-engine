      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
        {questions.map((question, index) => (
          <Button
            key={index}
            variant="outline"
            className="h-auto py-4 px-5 text-left text-sm whitespace-normal justify-start min-h-[60px] bg-transparent border-current text-inherit hover:bg-transparent hover:text-inherit hover:border-current"
