  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: "center" }}>
        ...
        <div style={{ fontSize: isMobile ? 16 : 14, color: C.whiteDim, marginTop: 2, lineHeight: 1.3 }}>
          Raw PDF/text parsed
          <br />
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: isMobile ? 14 : 12, color: C.whiteDim, marginTop: 2, lineHeight: 1.3 }}>
      ...
      <div style={{ position: "absolute", top: isMobile ? 12 : 16, left: 0, right: 0, textAlign: "center", zIndex: 3 }}>
        ...
        <div style={{ fontSize: isMobile ? 14 : 12, color: C.whiteDim, marginTop: 1, lineHeight: 1.3 }}>
