...
// ─── Color Constants (illustration-specific, not theme tokens) ────────────────
const C = {
  bg: '#0b1018',
  bgCard: '#0d1520',
  cyan: '#00e5ff',
  ...
  cyanBright: 'rgba(0,229,255,0.85)',
  red: '#ff3d5a',
  redDim: 'rgba(255,61,90,0.15)',
  redMid: 'rgba(255,61,90,0.4)',
  green: '#4ade80',
  greenDim: 'rgba(74,222,128,0.2)',
  white: '#e8edf5',
  whiteDim: 'rgba(232,237,245,0.5)',
  whiteFaint: 'rgba(232,237,245,0.15)',
};
...
@keyframes sp-coreGlow { 0%, 100% { box-shadow: 0 0 20px rgba(0,229,255,0.2), 0 0 40px rgba(0,229,255,0.1); } 50% { box-shadow: 0 0 30px rgba(0,229,255,0.35), 0 0 60px rgba(0,229,255,0.15); } }
      ...
      <div style={{ position: 'relative', width: docW + 24, height: docH + 10, marginBottom: 12 }}>
        ...
        <div
          style={{
            ...
            height: docH,
            borderRadius: 4,
            background: `linear-gradient(180deg, ${C.bgCard}, #0a0f16)`,
    ...
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', padding: isMobile ? '16px 8px' : '20px 12px', position: 'relative' }}>
      ...
      <div
        style={{
          ...
          height: chipSize,
          borderRadius: 10,
          background: `linear-gradient(135deg, ${C.bgCard}, #111a28)`,
      ...
      <div style={{ position: 'relative', width: dbW, height: dbH, margin: '0 auto 12px', animation: 'sp-dbPulse 3s ease-in-out infinite' }}>
        ...
        <div
          style={{
            ...
            width: dbW,
            height: dbH - dbW * 0.35,
            background: `linear-gradient(180deg, ${C.bgCard}, #080d14)`,
        ...
        <div
          style={{
            ...
            height: dbW * 0.35,
            borderRadius: '50%',
            background: `linear-gradient(180deg, ${C.cyanDim}, #080d14)`,
            border: `1px solid ${C.cyanDim}`,
          }}
        />
        {/* Glow */}
