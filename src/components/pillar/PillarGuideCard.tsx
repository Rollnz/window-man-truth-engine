          ...
          {guides.map((guide, index) => {
            ...
            return (
              <AnimateOnScroll key={index} delay={index * 120} duration={700}>
                <div className="group relative rounded-2xl bg-card backdrop-blur-sm border border-border/20 shadow-xl hover:shadow-2xl hover:scale-[1.02] hover:shadow-primary/10 transition-all duration-300 overflow-hidden">
                  {/* Colored top accent */}
                  <div className="h-1 bg-gradient-to-r from-primary to-primary/50" />
                  <div className="p-6 space-y-4">
                    <div className="w-12 h-12 rounded-xl bg-primary/10 border border-border/20 flex items-center justify-center">
