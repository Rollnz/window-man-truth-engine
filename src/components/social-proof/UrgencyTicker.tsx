...
export function UrgencyTicker({
  ...
  return <div ref={ref} className={cn("shadow-none flex items-end justify-center border-0 border-[#e3e3e3]/0", className)}>
      <div className={cn('inline-flex items-center divide-x rounded-lg border overflow-hidden whitespace-nowrap', styles.container)}>
        ...
        {showToday && <div className={cn('flex items-center gap-1.5 sm:gap-2 h-full flex-shrink-0', sizes.padding, styles.todayBg)}>
