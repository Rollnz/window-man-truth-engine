...
export function CloserSection({ onOpenLeadModal }: CloserSectionProps) {
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Button variant="cta" size="lg" className="group text-lg px-8 py-6 shadow-lg shadow-primary/20" onClick={handleUploadClick}>
              ...
              Upload My Estimate (Free Audit)
              <ArrowRight className="w-5 h-5 ml-2 transition-transform group-hover:translate-x-1" />
            </Button>
            <Button asChild variant="outline" size="lg" className="text-lg px-8 py-6 border-2" onClick={handleTalkClick}>
