        ...
        <div className="container px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <AnimateOnScroll direction="left" duration={700}>
              <div className="bg-card border border-border/50 rounded-2xl p-6 md:p-8 flex flex-col shadow-xl shadow-black/5 dark:shadow-black/20 ring-1 ring-primary/10 hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 h-full">
            ...
            <AnimateOnScroll direction="right" duration={700} delay={150}>
              <div className="relative bg-card border-2 border-primary/30 rounded-2xl p-6 md:p-8 flex flex-col shadow-xl shadow-black/5 dark:shadow-black/20 shadow-[0_0_30px_-5px_hsl(var(--primary)/0.15)] hover:shadow-[0_0_40px_-5px_hsl(var(--primary)/0.25)] hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 h-full">
