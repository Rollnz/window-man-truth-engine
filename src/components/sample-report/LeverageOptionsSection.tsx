...
export function LeverageOptionsSection({
  ...
  return <section ref={sectionRef} className="py-16 md:py-24 bg-[hsl(var(--surface-1))]">
        <div className="container px-4">
          ...
          <div className="max-w-2xl mx-auto mt-8 font-semibold"><div className="flex items-center justify-center gap-2 text-sm text-muted-foreground"><Shield className="w-4 h-4 text-primary" /><span>Either way, the audit is free whether you use your contractor or ours.</span></div></div>
        </div>
    </section>;
}