...
function TranscriptEntry({ item, index }: { item: FAQItem; index: number }) {
  ...
  return (
    <div
      ref={entryRef}
      className={`relative border-b border-border/30 py-8 last:border-b-0 transition-all duration-500 ${
      ...
      <div className="pl-8 md:pl-12 relative">
        <div className="flex items-start gap-3">
          ...
          <div className="relative flex-1">
            ...
            {/* DECLASSIFIED Stamp */}
            <div
              className={`absolute -right-2 md:right-0 -bottom-2 md:-bottom-4 pointer-events-none select-none transition-all duration-300 ${
                showStamp ? 'opacity-15 scale-100' : 'opacity-0 scale-150'
              }`}
